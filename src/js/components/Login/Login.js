        ...
        return (
            ...
            <MusicPlayer/>
                <form className="login-container">
                    ...
                    <a id="google-login" href="https://kevl927.github.io/ASyncIn-Client/auth/google" className="google-login">Log in with Google</a><br />
                    <a id="facebook-login" href="https://kevl927.github.io/ASyncIn-Client/auth/facebook" className="facebook-login">Log in with Facebook</a>
                </form>
